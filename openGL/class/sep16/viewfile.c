...
void readcar()
{
  ...
  while(fscanf(fd,"%lf %lf %lf %lf %lf %lf\n",&x1,&y1,&z1,&x2,&y2,&z2) == 6){
    ...
    linelist.lines[linelist.nlines].x1 = x1;
    linelist.lines[linelist.nlines].y1 = y1;
    linelist.lines[linelist.nlines].z1 = z1;
    linelist.lines[linelist.nlines].x2 = x2;
    linelist.lines[linelist.nlines].y2 = y2;
    linelist.lines[linelist.nlines].z2 = z2;
    linelist.nlines++;
  }
  fclose(fd);
}
