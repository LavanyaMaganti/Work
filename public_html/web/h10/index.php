<?php
 ...
 <style>
  ...
  <body>
 <ul class="tab">
 <input type="button" id="defaultOpen" class="link" onclick="table(event,'People')" value="People">
 <input type="button" class="link" onclick="table(event,'Contacts')" value="Contacts">
 <input type="button" class="link" onclick="table(event,'Departments')" value="Departments">
 </ul>
