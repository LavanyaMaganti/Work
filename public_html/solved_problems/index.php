...
<p id="head"></p>
<center>
<form name="form" method="post" action="index.php" onsubmit='return formValidation()'>
<?php
                                 ...
                                 //
                                   //
                                     //     mysql_select_db('student');
                                       //
                                         //     // sql to create table
                                           //     $sql = "INSERT INTO STUDENT(FirstName,LastName,Email,Dept) VALUES 
                                           ('$_POST[firstname]','$_POST[lastname]','$_POST[email]','$_POST[course]')";
                                             //
                                               //
